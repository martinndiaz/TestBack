...
from .views import AppointmentCreateView, AvailabilityListCreateView, KinesiologistAvailableSlotsView, patient_appointments_history
...
urlpatterns = [
    ...
    path("patient/history/", patient_appointments_history),
